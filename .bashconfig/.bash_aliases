...
alias init="cd ~/Desktop/'Code 3'/C/kilo ; vim kilo.c"
...
alias limbo='cd /media/jayson/Limbo'
alias clit='vim /media/jayson/Limbo/LogClips/clipList'
alias code="cd ~/Desktop/'Code 3'"
